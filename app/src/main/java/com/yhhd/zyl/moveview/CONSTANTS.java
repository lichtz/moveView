...
public class CONSTANTS {
	...
	public final static String FILE_START_NAME = "V_";
	...
	public final static String WITH_FOLDER = "/with";
	public final static String WITH_TEMP_IMAGE = "/Image";
	...
	public final  static  String TEMP_PIC_PATH =Environment.getExternalStorageDirectory().getAbsolutePath() +WITH_FOLDER +TEMP_FOLDER+WITH_TEMP_IMAGE+"/";
	public final  static  String TEMP_VIDEO_PATH =Environment.getExternalStorageDirectory().getAbsolutePath() +WITH_FOLDER +TEMP_FOLDER+CAMERA_FOLDER+"/";
	public final  static  String FINAL_VIDEO_PATH =  Environment.getExternalStorageDirectory().getAbsolutePath() +WITH_FOLDER +CAMERA_FOLDER+"/";
